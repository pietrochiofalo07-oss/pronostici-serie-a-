...
st.caption("Modello predittivo calibrato su dati e rose ufficiali aggiornate.")

FOOTBALL_DATABASE = {
    "Serie A": {
        "Inter": {"att": 90, "def": 87, "strikers": ["Lautaro Martínez", "Marcus Thuram", "Hakan Çalhanoğlu"]},
        "Juventus": {"att": 84, "def": 87, "strikers": ["Dušan Vlahović", "Kenan Yıldız", "Teun Koopmeiners"]},
        "Milan": {"att": 85, "def": 82, "strikers": ["Álvaro Morata", "Rafael Leão", "Christian Pulisic"]},
        "Atalanta": {"att": 88, "def": 80, "strikers": ["Mateo Retegui", "Ademola Lookman", "Charles De Ketelaere"]},
        "Napoli": {"att": 85, "def": 83, "strikers": ["Romelu Lukaku", "Giacomo Raspadori", "Scott McTominay"]},
        "Roma": {"att": 86, "def": 84, "strikers": ["Donyell Malen", "Matias Soulé", "Paulo Dybala"]},
        "Bologna": {"att": 79, "def": 78, "strikers": ["Artem Dovbyk", "Riccardo Orsolini", "Thijs Dallinga"]},
        "Lazio": {"att": 80, "def": 79, "strikers": ["Taty Castellanos", "Mattia Zaccagni", "Boulaye Dia"]},
        "Fiorentina": {"att": 79, "def": 77, "strikers": ["Moise Kean", "Albert Guðmundsson", "Andrea Colpani"]},
        "Torino": {"att": 73, "def": 77, "strikers": ["Duván Zapata", "Antonio Sanabria", "Nikola Vlašić"]},
        ...
        "Como": {"att": 72, "def": 70, "strikers": ["Patrick Cutrone", "Nico Paz", "Andrea Belotti"]},
    ...
    "Premier League": {
        "Manchester City": {"att": 94, "def": 88, "strikers": ["Erling Haaland", "Phil Foden", "Kevin De Bruyne"]},
        ...
        "Manchester United": {"att": 81, "def": 78, "strikers": ["Rasmus Højlund", "Marcus Rashford", "Bruno Fernandes"]},
    ...
    "LaLiga": {
        ...
        "Atlético Madrid": {"att": 86, "def": 87, "strikers": ["Julian Alvarez", "Antoine Griezmann", "Alexander Sørloth"]},
    ...
    "Bundesliga": {
        ...
        "Bayer Leverkusen": {"att": 89, "def": 84, "strikers": ["Florian Wirtz", "Victor Boniface", "Patrik Schick"]},
        "RB Lipsia": {"att": 85, "def": 82, "strikers": ["Benjamin Šeško", "Loïs Openda", "Xavi Simons"]},
        "Borussia Dortmund": {"att": 86, "def": 80, "strikers": ["Serhou Guirassy", "Donyell Malen", "Julian Brandt"]}
    },
    "Ligue 1": {
        "PSG": {"att": 92, "def": 85, "strikers": ["Khvicha Kvaratskhelia", "Bradley Barcola", "Ousmane Dembélé"]},
...
if home_team == away_team:
    ...
    if st.button("🚀 Calcola Pronostico IA Completo", type="primary"):
        ...
        # Formula di calcolo xG calibrata per riflettere le differenze di categoria
