...
FOOTBALL_DATABASE = {
    "🇮🇹 Serie A": {
        ...
        "Napoli": {"att": 83, "def": 82, "strikers": ["Romelu Lukaku", "Khvicha Kvaratskhelia", "Scott McTominay"]},
        "Roma": {"att": 80, "def": 79, "strikers": ["Artem Dovbyk", "Paulo Dybala", "Matías Soulé"]},
        ...
        "Bologna": {"att": 76, "def": 77, "strikers": ["Thijs Dallinga", "Santiago Castro", "Riccardo Orsolini"]},
